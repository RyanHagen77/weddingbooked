...
<div className="bg-white min-h-screen px-4 md:px-12 py-10 md:py-16 text-gray-800">
  <div className="max-w-5xl mx-auto">

    {isSubmitted ? (
      <div className="text-center p-6 mb-10 bg-gray-100 rounded-lg border border-gray-300">
        <h2 className="font-semibold text-xl mb-2">Wedding Day Guide Submitted</h2>
        <p>This guide has already been submitted and cannot be modified.</p>
      </div>
    ) : (
      <>
        <h1 className="text-3xl md:text-4xl font-bold mb-8 text-center tracking-wide border-b-2 border-rose-200 pb-4">Wedding Planning Guide</h1>

        <div className="text-center p-6 mb-10 bg-rose-50 border border-rose-200 rounded-lg">
          <h2 className="font-bold text-lg text-rose-800 mb-2">Emergency Contact</h2>
          <p className="text-sm text-rose-900">(847) 780-7092: Contact Essence with this number in case of any emergency on your wedding day.</p>
        </div>

        <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
          {/* General Info */}
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-gray-50 p-6 rounded-lg border">
            <div className="space-y-4">
              ...
              <label className="block text-sm font-medium">Partner 1</label>
              ...
              <label className="block text-sm font-medium">Primary Cell #</label>
              <input type="tel" {...register("primary_phone", {required: true})} className="input"/>
            </div>

            <div className="space-y-4">
              <label className="block text-sm font-medium">Partner 2</label>
              <input type="text" {...register("partner_contact", {required: true})} className="input"/>

              <label className="block text-sm font-medium">Partner Email</label>
              <input type="email" {...register("partner_email", {required: true})} className="input"/>

              <label className="block text-sm font-medium">Partner Cell #</label>
          ...
          <section className="bg-gray-50 p-6 rounded-lg border">
            <h2 className="text-xl font-bold mb-2 text-rose-800 border-b border-rose-200 pb-2">Ceremony Location</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
          ...
          <section className="bg-gray-50 p-6 rounded-lg border">
            <h2 className="text-xl font-bold mb-2 text-rose-800 border-b border-rose-200 pb-2">Reception Location</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
          ...
          <section className="bg-gray-50 p-6 rounded-lg border">
            <h2 className="text-xl font-bold mb-2 text-rose-800 border-b border-rose-200 pb-2">Location Photo Stops</h2>
            <p className="text-sm text-gray-700 mb-4">It is recommended that you only have 1–2 photo location stops, and
          ...
          <section className="bg-gray-50 p-6 rounded-lg border">
            <h2 className="text-xl font-bold mb-2 text-rose-800 border-b border-rose-200 pb-2">For The 2nd Photographer
              (If Booked)</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
          ...
          <div className="p-4 bg-gray-100 rounded-lg mb-6">
            ...
            <p>Your final video will be delivered through Vimeo, the same cutting-edge platform trusted across the
              industry. We host it online for one year. Please be sure to download and save your video right away. After
              one year, the link will expire and be removed from our hosting. Feel free to store it wherever you like
            ...
            <div className="mt-4 p-4 border-l-4 border-blue-400 bg-blue-50 rounded">
              ...
              <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1">
                <li>We arrive at least 1 hour before the ceremony to set up and capture essential highlight shots and
            ...
            <p><strong className="text-red-600">Only if we’re there for 2 hours of open dancing.</strong> Make sure your
            ...
            <p>Your dance montage will be an upbeat collection of footage shot during the general dancing portion of
              ...
              charged a fee. We cannot complete your video without BOTH your Wedding Story and Dance Montage songs.</p>
            ...
            <div className="mt-4 p-4 border-l-4 border-blue-400 bg-blue-50 rounded">
              ...
              <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1">
                ...
                <li>If we&rsquo;re there for 2+ hours of open dancing late night, they&rsquo;ll get a dance highlight
                  included.
                </li>
              </ul>
            </div>
            ...
            <div className="mt-4 p-4 border-l-4 border-yellow-400 bg-yellow-50 rounded">
              ...
              <p>Just remember: if you want early coverage, you may need to extend hours to ensure we’re there late for
                open dancing.</p>
              <p className="mt-2">Other than our highlights, just a reminder of the specific chapters we showed you in
              ...
              <p>If you have any other special dances or important moments, please list them below so we can make sure
          ...
          <div className="p-4 bg-gray-100 rounded-lg mb-6">
            ...
            <p className="mt-4">How would you like your names and wedding date to appear on your photo strip? (e.g., Kim
            ...
            <p className="mt-6">
              ...
              need a 5&apos;x7&apos; space within 15 feet of an outlet, and a skirted high-top table. (Example: You will
              be in the far corner of the room next to the head table, or you will be in the front, just inside the
              doors.)
            </p>
