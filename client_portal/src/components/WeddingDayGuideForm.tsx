            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-[#fdf4f5] p-6 rounded-lg border border-gray-200 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <input
                  ...
                  className={inputClass}
                />
                <p className="text-xs text-gray-500 mt-1">Format: name@example.com</p>
              ...
              <div className="space-y-4">
                ...
                <input
                  ...
                  className={inputClass}
                />
                <p className="text-xs text-gray-500 mt-1">Format: partner@example.com</p>
              ...
              <section className="p-6 bg-[#fdf4f5] rounded-lg border border-pinkbrand shadow-sm mb-10">
                ...
                <p className="mb-6 text-sm text-gray-700 font-sans">
                  Please add your photo requests below. We will do our best to get to all of them, time and weather
                  permitting.
                </p>
              ...
              <section className="p-6 bg-[#fdf4f5] rounded-lg border border-pinkbrand shadow-sm mb-10">
                ...
                <p className="text-sm text-gray-700 font-sans mb-4">
                  Essence cannot process your video until you have provided us with the following information. Please be
                  aware that if you&#39;d like your videographer to be there for bridal prep or a first look, this
                  footage will be included in your <strong>Wedding Story Highlight Reel only</strong>.
                </p>
                <p className="text-sm text-gray-700 font-sans mb-4">
                  All video packages require our videographer to begin <strong>1 hour before the ceremony</strong> at
                  the ceremony site for establishing footage and audio set-up.
                </p>
                <p className="text-sm text-gray-700 font-sans mb-4">
                  Also, please be aware that including bridal prep or first look footage may reduce the time allowed for
                  open dance floor coverage, which could impact our ability to produce a <strong>Dance Montage Highlight
                  Reel</strong> if there are fewer than 2 hours of open dancing.
                </p>
                <p className="text-sm text-gray-700 font-sans mb-4">
              ...
              <div>
                <label htmlFor="video_arrival_location" className="block text-sm font-medium text-gray-700">Video
                  Arrival Location:</label>
                <input type="text" id="video_arrival_location" {...register("video_arrival_location")}
                       className={inputClass}/>
              </div>

              <label htmlFor="video_client_names" className="block text-sm font-medium text-gray-700 mb-1">Please type
                your names below EXACTLY as you would like them to appear in the final video.</label>
              ...
              <div className="mt-8">
                ...
                <p className="text-sm text-gray-700 font-sans mb-4">
                  This is a highlight reel from your entire wedding day. Please choose one slow or medium-tempo song
                  that is 3–4 minutes long. Shorter songs will reduce how much footage can be included. Re-edits due to
                  song length will incur a fee.
                </p>
              ...
              <div className="mt-8">
                ...
                <p className="text-sm text-gray-700 font-sans mb-4">
                  Your Dance Montage will be an upbeat collection of footage shot during general dancing, paired with
                  one energetic song.
                </p>
              ...
              <div className="mt-8">
                ...
                <p className="text-sm text-gray-700 font-sans mb-4">
                  In addition to your highlight videos, your final product will include other key live footage chapters:
                  Ceremony, Introductions, Cake Cutting, Toasts, First Dance, Special Dances (e.g., Father/Daughter,
                  Mother/Son), and Bouquet/Garter Toss — if those events occur while the videographer is present.
                </p>
                ...
                <label htmlFor="video_special_dances" className="block text-sm font-medium text-gray-700">Other Dances
                  or Moments to Include:</label>
                <input id="video_special_dances" type="text" {...register("video_special_dances")}
                       className={inputClass}/>
              </div>
            </section>
