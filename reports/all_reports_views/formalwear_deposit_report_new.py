...
def formalwear_deposit_report_new(request):
    ...
    total_deposit_sum = 0  # Initialize total deposit sum
    ...
    for contract in contracts:
        ...
        if formalwear_qs.exists():
            ...
            if deposit_sum > 0:
                ...
                total_deposit_sum += deposit_sum  # Add to total deposit sum
    ...
    context = {
        ...
        'locations': locations,
        'total_deposit_sum': total_deposit_sum,  # Pass total deposit sum
    }
