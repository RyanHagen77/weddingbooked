...
class WeddingDayGuide(models.Model):
    ...
    p1_parent_names = models.CharField(max_length=255, null=True, blank=True)
    p1_sibling_names = models.CharField(max_length=255, null=True, blank=True)
    p1_grandparent_names = models.CharField(max_length=255, null=True, blank=True)
    p2_parent_names = models.CharField(max_length=255, null=True, blank=True)
    p2_sibling_names = models.CharField(max_length=255, null=True, blank=True)
    p2_grandparent_names = models.CharField(max_length=255, null=True, blank=True)
    ...
    video_arrival_time = models.TimeField(null=True, blank=True)
    video_arrival_location = models.CharField(max_length=255, null=True, blank=True)
    ...
    photo_booth_text_line1 = models.CharField(max_length=255, null=True, blank=True)
    photo_booth_text_line2 = models.CharField(max_length=255, null=True, blank=True)
