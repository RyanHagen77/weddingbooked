...
urlpatterns = [
    ...
    path('tasks/create/internal/', views.create_internal_task, name='create_internal_task'),
    path('tasks/get/', views.get_internal_tasks, name='get_internal_tasks'),
    path('tasks/create/note/<int:note_id>/', views.create_contract_task, name='create_task_for_note'),
    ...
    path('tasks/get/', views.get_internal_tasks, name='get_internal_tasks'),
    path('tasks/create/contract/', views.create_contract_task, name='create_contract_task'),
